    ...
    return (
        <div>
                        ...
                        <Box display="flex" alignItems="center">
                            ...
                            <Box px={1}>
                                <Typography className="hotel_name">
                                    Vondelpark and Old West Neighbourhood Walking Audio Tour By VoiceMap
                                </Typography>
            ...
            >
                ...
                <Grid container  my={2}>
                    <Grid sm={2}>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Language</Typography>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>English - Audio</Typography>
                    </Grid>
                    <Grid sm={6}>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Option</Typography>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Vondepark and Old West Neighbourhood: A Self-Guided Audio Tour</Typography>
                    </Grid>
                    <Grid sm={1}>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Duration</Typography>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>1 Hour</Typography>
                    </Grid>
                    <Grid sm={1}>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Price</Typography>
                        <Typography sx={{fontSize:'12px',color:'#252525',fontWeight:'bold'}}>Rs. ₹2345</Typography>
                    </Grid>
