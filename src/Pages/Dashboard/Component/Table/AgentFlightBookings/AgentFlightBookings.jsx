        ...
        <tbody>
          {flightBookings.map((booking) => (
            <tr key={booking._id}>
              ...
              <td>{booking.pnr}</td>
              <td>{booking.UserDetails[0].agency_details.agency_name}</td>
              <td>{`${booking.UserDetails[0].personal_details.first_name}${booking.UserDetails[0].personal_details.last_name}`}</td>
              <td>
              {booking.UserDetails[0]
                ? `${booking.UserDetails[0].personal_details.email}`
                : "Empty"}
            </td>
            ...
            <td>
              {booking.airlineDetails[0]?.Airline?.AirlineName || ""}
            </td>
            <td>
              {booking.airlineDetails[0]?.Origin?.DepTime || ""}
            </td>
