    ...
    <Box p={3} backgroundColor="#F5F5F5" borderRadius="10px">
      <Box>
        ...
        <Box alignItems="center" display="flex" justifyContent="center">
          <Rating value={hotelDetails?.StarRating} />
        </Box>
        <Box>
      ...
      >
        Incl:{hotelDetails?.HotelRoomsDetails[0]?.Inclusion[0]}
      </Typography>
      <Typography
        mt={2}
        sx={{ fontSize: "16px", color: "#FF8900", fontWeight: "bold" }}
      >
        Last Cancellation Date: {cancelDuedate}(23:59:59)
      </Typography>
      ...
      {hotelDetails?.HotelRoomsDetails[0]?.HotelPassenger.map((name, index) => {
        return (
      ...
      >
        ...
        >
          Room Type: {hotelDetails?.HotelRoomsDetails[0]?.RoomTypeName}
        </Typography>
